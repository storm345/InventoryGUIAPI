 ...
 */
public class GUIPickupItemEvent extends GUIClickEvent implements Cancellable {

    public GUIPickupItemEvent(GUISession session, Player viewer, int inventorySlot, GUIElement interactedElement, InventoryClickEvent bukkitEvent){
